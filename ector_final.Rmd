...
length(activated.26vs10.k4.gene.body)
...
rowMeans(2^mat.normalized.peak.cpm[activated.peaks.temp26c.vs.temp10c,paste("k4_temp26",1:3,sep="_")]),outline=F,col=c("#00FFFF","#6699FF", "#CC33FF","#FF0000"),ylab="CPM",names=c("10ºC","14ºC","20ºC","26ºC"),las=2,cex.lab=1)
```
...
gene.body.k4.activated.26vs10 <- temp26vs10.k4.peak.annotation$activated.genes.k4.26vs10[temp26vs10.k4.peak.annotation$peak.annotation.k4.26vs10 == "TSS"]
length(activated.26vs10.k4.gene.body)



boxplot(temp10.gene.expression[gene.body.k4.activated.26vs10],
        temp14.gene.expression[gene.body.k4.activated.26vs10],
        temp20.gene.expression[gene.body.k4.activated.26vs10],
        temp26.gene.expression[gene.body.k4.activated.26vs10],
        col=c("blue","green","cyan","red"),
        outline=F)

wilcox.test(x = temp10.gene.expression[gene.body.k4.activated.26vs10], 
            y = temp14.gene.expression[gene.body.k4.activated.26vs10],
            alternative = "less")
wilcox.test(x = temp14.gene.expression[gene.body.k4.activated.26vs10], 
            y = temp20.gene.expression[gene.body.k4.activated.26vs10],
            alternative = "less")

wilcox.test(x = temp20.gene.expression[gene.body.k4.activated.26vs10],,
            y = temp26.gene.expression[gene.body.k4.activated.26vs10],
            alternative = "less")
