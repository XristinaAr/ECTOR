...
three different independent biological replicates. We compute the percentage of the whole genome occupied by H3K27me3 and the percentage in each chromosome. A 
...
H3K27me3 is mostly uniformly distributed over the different chromosome although it significantly accumulates (p-value < 0.01) in Chr2 (sexual chromosome) and 
...
H3K27me3 is only partially associated with Transposable Elements. More than 84% of the peaks did not overlap with any TE. Only 1.5%, 0.5% and 13.5% of the 
...
(kinesin) and ostta08g03710 (tubulin alpha).
